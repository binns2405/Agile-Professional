<!DOCTYPE html>
<!-- Made By Michael, Adam, Harvey and Charlie  2024 -->
<html lang="en">
...
<body class="fade-in">
  ...
  <main>
    <div class="wrapperOpendays">
      ...
      if (mysqli_num_rows($result) > 0) {
        ...
        echo "Sorry, there are no available open days at the moment. Check out this page again soon and look on our socials for more info.";
      }
      ?>
  ...
  <footer>
    ...
    <div class="FooterCol-2">
      <h3><u>Contact</u></h3>
      <a href="mailto:suinformation@uclan.ac.uk">Email: suinformation@uclan.ac.uk</a>
