...
body {
	...
	background-image: url("Assignment1/Images/BackgroundImages/MountainBackground.jpg");
...
.list-item1:hover ~ body {
    background-image: url("Assignment1/Images/BackgroundImages/Assignment1.PNG");
  }
